...
//    CALL_YOUR_GIRLFRIEND("spotify:track:2sCoROOlNQyFpRQEe6A5lv", new StatRange(new SingleAxisStatRange(- Math.PI, Math.PI, 0.5, 1.7, 19.9, 28.0), new SingleAxisStatRange(-0.05, 0.5, 0.35, 0.9, 11.0, 22.0), new SingleAxisStatRange(-0.8, -0.2, 0.5, 1.2, 19.9, 28.0))),
    CALL_YOUR_GIRLFRIEND("spotify:track:2sCoROOlNQyFpRQEe6A5lv", new StatRange(new SingleAxisStatRange(- Math.PI, Math.PI, 0.5, 2.1, 19.9, 28.0), new SingleAxisStatRange(-0.05, 0.5, 0.35, 0.9, 11.0, 26.0), new SingleAxisStatRange(-1.0, -0.2, 0.5, 1.3, 19.9, 28.0))),
    NONE(null, null);

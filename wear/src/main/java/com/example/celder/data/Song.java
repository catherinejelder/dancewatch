...
//    SINGLE_LADIES("spotify:track:5R9a4t5t5O0IsznsrKPVro", new StatRange(new SingleAxisStatRange(-2.3, 1.6, 1.3, 2.5, 7.0, 16.7), new SingleAxisStatRange(-0.05, 0.34, 0.10, 0.44, 5.0, 16.7), new SingleAxisStatRange(-1.6, -1.4, 0.1, 0.9, 5.0, 16.7))),
    SINGLE_LADIES("spotify:track:5R9a4t5t5O0IsznsrKPVro", new StatRange(new SingleAxisStatRange(-Math.PI, Math.PI, 1.3, 2.5, 7.0, 16.7), new SingleAxisStatRange(-0.05, 0.34, 0.10, 0.44, 5.0, 16.7), new SingleAxisStatRange(-1.6, -1.4, 0.1, 0.9, 5.0, 16.7))),
    NONE(null, null);

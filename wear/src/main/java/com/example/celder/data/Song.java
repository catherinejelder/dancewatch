...
//    SINGLE_LADIES("spotify:track:5R9a4t5t5O0IsznsrKPVro", new StatRange(new SingleAxisStatRange(-2.3, 1.6, 1.3, 2.5, 7.0, 15.1), new SingleAxisStatRange(-0.05, 0.34, 0.10, 0.44, 3.9, 32.5), new SingleAxisStatRange(-1.6, -1.4, 0.1, 0.9, 7.0, 15.1))),
    SINGLE_LADIES("spotify:track:5R9a4t5t5O0IsznsrKPVro", new StatRange(new SingleAxisStatRange(-2.3, 1.6, 1.3, 2.5, 7.0, 16.7), new SingleAxisStatRange(-0.05, 0.34, 0.10, 0.44, 7.0, 16.7), new SingleAxisStatRange(-1.6, -1.4, 0.1, 0.9, 7.0, 16.7))),
    NONE(null, null);
